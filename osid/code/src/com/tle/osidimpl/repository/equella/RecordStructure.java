...
implements org.osid.repository.RecordStructure
{
    ...
    {
        return "Equella Record Structure";
    }

    public String getDescription()
    throws org.osid.repository.RepositoryException
    {
        return "Content of a Equella Record Structure Asset Record";
    }
    ...
    throws org.osid.repository.RepositoryException
    {
        try
        {
            return Configuration.getInstance().getIdManager().getId("com.theLearningEdge.equella.recordStructureId");
        }
        catch (Throwable t)
        {
    ...
    throws org.osid.repository.RepositoryException
    {
        return new Type("com.theLearningEdge","record","equellaLibraryContent");
    }
    ...
    throws org.osid.repository.RepositoryException
    {
        ...
        try
        {
            ...
            results.addElement(DateCreatedPartStructure.getInstance());
            results.addElement(DateModifiedPartStructure.getInstance());
            results.addElement(DateForIndexPartStructure.getInstance());
            results.addElement(DescriptionPartStructure.getInstance());
            results.addElement(FileDisplayNamePartStructure.getInstance());
            results.addElement(FileNamePartStructure.getInstance());
            results.addElement(FileSizePartStructure.getInstance());
            results.addElement(SizeInKBPartStructure.getInstance());
            results.addElement(NewItemPartStructure.getInstance());
            results.addElement(OwnerIdPartStructure.getInstance());
            results.addElement(RatingAvgPartStructure.getInstance());
            results.addElement(SizeInKBPartStructure.getInstance());
            results.addElement(TitlePartStructure.getInstance());
    ...
    throws org.osid.repository.RepositoryException
    {
        return "com.theLearningEdge.equella.recordSchema";
    }
