...
implements org.osid.repository.PartStructure
{
    ...
    protected TitlePartStructure()
    {
        try
        {
            this.TITLE_PART_STRUCTURE_ID = Configuration.getInstance().getIdManager().getId("Title.PartStructureId");
        }
        catch (Throwable t)
        {
        }        
    ...
    throws org.osid.repository.RepositoryException
    {
        return this.TITLE_PART_STRUCTURE_ID;
    }
