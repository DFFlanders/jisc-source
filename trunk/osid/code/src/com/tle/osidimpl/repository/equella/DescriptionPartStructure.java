...
{
    private org.osid.shared.Id DESCRIPTION_PART_STRUCTURE_ID = null;
    ...
    private String description = "An account of the content of the resource.";
    private boolean mandatory = false;
    private boolean populatedByRepository = false;
    private boolean repeatable = true;
	private static DescriptionPartStructure descriptionPartStructure = new DescriptionPartStructure();
	
	protected static DescriptionPartStructure getInstance()
	{
    ...
    protected DescriptionPartStructure()
    {
        try
        {
            this.DESCRIPTION_PART_STRUCTURE_ID = Configuration.getInstance().getIdManager().getId("Description.PartStructureId");
        }
        catch (Throwable t)
        {
        }        
    ...
    throws org.osid.repository.RepositoryException
    {
        return this.DESCRIPTION_PART_STRUCTURE_ID;
    }
