...
implements org.osid.repository.RecordStructure
{
    ...
    {
        return "Fedora Record Structure";
    }

    public String getDescription()
    throws org.osid.repository.RepositoryException
    {
        return "Content of a Fedora Record Structure Asset Record";
    }
    ...
    throws org.osid.repository.RepositoryException
    {
        try
        {
            return Configuration.getInstance().getIdManager().getId("org.fedora-commons.recordStructureId");
        }
        catch (Throwable t)
        {
    ...
    throws org.osid.repository.RepositoryException
    {
        return new Type("org.fedora-commons","record","content");
    }
    ...
    throws org.osid.repository.RepositoryException
    {
        ...
        try
        {
          /*  results.addElement(TitlePartStructure.getInstance());
            ...
            results.addElement(LastEditorPartStructure.getInstance());
            results.addElement(FormatPartStructure.getInstance());
            results.addElement(FormatMIMETypePartStructure.getInstance());
    ...
    throws org.osid.repository.RepositoryException
    {
        return "org.fedora-commons.recordSchema";
    }
